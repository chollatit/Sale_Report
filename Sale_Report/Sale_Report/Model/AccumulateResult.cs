...
namespace Sale_Report.Model
{
    class AccumulateResult
    {
        ...
        internal DataSet selectOverAllActual(string yearMonthBegin, string yearMonthEnd, string groupDesc)
        {
            try
            {
                string strCmd = "SELECT  '" + groupDesc + "' as groupcd, '" + yearMonthEnd + "' as i_year_mnth, ";
                strCmd += "SUM (ta.i_amt) AS i_amt ";
        ...
        internal DataSet selectProjecjOEMNCDataOAP(string yearMonth)
        {
            try
            {
                string strCmd = "select 'NC Data Sales' as groupcd, '" + yearMonth + "' as i_year_mnth, 0 as i_amt from dual";
        ...
        internal DataSet selectProjectOEMOEMPartYearOAP(string yearMonth)
        {
            try
            {
                string strCmd = "SELECT   'OEM' AS groupcd, ta.i_year_mnth, ";
                strCmd += "SUM (  (  ta.i_mnth_plan_qty1 ";
                strCmd += "+ ta.i_mnth_plan_qty2 ";
                strCmd += "+ ta.i_mnth_plan_qty3 ";
                strCmd += "+ ta.i_mnth_plan_qty4 ";
                ...
                strCmd += ") AS i_amt ";
                strCmd += "FROM t_is_f20m_kanban_plan_head_tr ta ";
                strCmd += "WHERE TRIM (ta.i_item_cd) IN (SELECT TRIM (tb.i_item_cd) ";
        ...
        internal DataSet selectProjectOEMYearOAP(string yearMonth, string groupcd, string projectDesc)
        {
            try
            {
                string strCmd = "SELECT   '" + groupcd + "' AS groupcd, ta.i_year_mnth, ";
                ...
                strCmd += "AND tb.i_fac_cd = 'FAC01') ";
                strCmd += ") AS i_amt ";
                strCmd += "FROM t_is_f20m_kanban_plan_head_tr ta INNER JOIN t_pm_ms td ";
                strCmd += "ON trim(ta.i_item_cd) = trim(td.i_item_cd) ";
        ...
        internal DataSet selectProjectOEMOEMPartActual(string yearMonthBegin, string yearMonthEnd)
        {
            try
            {
                string strCmd = "SELECT  'OEM' as groupcd, '"+yearMonthEnd+"' as i_year_mnth, ";
                strCmd += "SUM (ta.i_amt) AS i_amt ";
                strCmd += "FROM t_ship_tr ta ";
                strCmd += "WHERE TO_CHAR (ta.i_ship_date, 'mmyyyy') between '" + yearMonthBegin + "' and '" + yearMonthEnd + "' ";
        ...
        internal DataSet selectProjectOEMActual(string yearMonthBegin, string yearMonthEnd, string groupCD, string projectDesc)
        {
            try
            {
                string strCmd = "SELECT  '" + groupCD + "' as groupCD, '"+yearMonthEnd+"' as i_year_mnth, ";
                strCmd += "SUM (ta.i_amt) AS i_amt ";
                strCmd += "FROM t_ship_tr ta INNER JOIN t_pm_ms td ";
        ...
        internal DataSet selectProjectOEMUAMActual(string yearMonthBegin, string yearMonthEnd, string groupCD)
        {
            try
            {
                string strCmd = "SELECT  '" + groupCD + "' as groupCD, '" + yearMonthEnd + "' as i_year_mnth, ";
                ...
                strCmd += "FROM t_ship_tr ta ";
                strCmd += "WHERE TO_CHAR (ta.i_ship_date, 'mmyyyy') between '" + yearMonthBegin + "' and '" + yearMonthEnd + "' ";
                strCmd += "AND TRIM (ta.i_del_dest_cd) = '8-1-011-3'";
                strCmd += "AND ta.i_inv_no IS NOT NULL ";
        ...
        internal DataSet selectProjecjOEMUAMOAP(string yearMonth)
        {
            try
            {
                string strCmd = "select 'UAM NG Scrap Sales' as groupcd, '" + yearMonth + "' as i_year_mnth, 0 as i_amt from dual";
        ...
        internal DataSet selectAccProjectOEMOtherOAP(string yearMonthBegin, string yearMonthEnd, string groupcd)
        {
            try
            {
                int month = Convert.ToInt32(yearMonthEnd.Substring(0, 2));
        ...
        internal DataSet selectAccProjectOEMOAP(string yearMonthBegin, string yearMonthEnd, string groupcd, string projectDesc)
        {
            try
            {
                int month = Convert.ToInt32(yearMonthEnd.Substring(0, 2));
        ...
        internal DataSet selectAccProjectOEMOEMPartOAP(string yearMonthBegin, string yearMonthEnd, string groupcd)
        {
            try
            {
                int month = Convert.ToInt32(yearMonthEnd.Substring(0, 2));
