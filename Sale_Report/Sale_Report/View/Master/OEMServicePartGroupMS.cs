...
{
    public partial class OEMServicePartGroupMS : Form
    {
        OEMServicePartMS oemService = new OEMServicePartMS();

        DataSet dsOemServicePartList = null;
        string processCls = "";

        public OEMServicePartGroupMS()
        {
            InitializeComponent();

            initDGVListOemServicePart();
            txtNameSchema.Text = "SCHEMA : " + oemService.obj.oracle.User;
        ...
        private void initDGVListOemServicePart()
        {
            dsOemServicePartList = new DataSet();
            dsOemServicePartList = oemService.selectOemServicePartList();

            if (dsOemServicePartList == null)
            {
            ...
            {
                dgvListOEMItemCD.DataSource = dsOemServicePartList.Tables[0];
            }
        }
        ...
        private string findItemDesc(string itemCD)
        {
            ...
            {
                string itemDesc = "";
                DataSet dsTmp = oemService.selectItemDetail(itemCD);
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            if (processCls == "add")
            {
                ...
                DataRow[] dr = dsOemServicePartList.Tables[0].Select(strCmd);
                ...
                else
                {
                    ...
                    {
                        int result = oemService.insertOEMItem(itemCD, itemDesc);
            ...
            else if (processCls == "del")
            {
                ...
                {
                    int result = oemService.deleteItemCD(itemCD);
